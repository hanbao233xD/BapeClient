...
public class AutoL extends Module {
    ...
    static String[] LMessagesFrançais = {
            "Tu me fais chier.",
            "T'es con, ou quoi?",
            "Marche à l'ombre!",
            "Casse-toi !",
    ...
    public void keyInput(InputEvent.KeyInputEvent event) {
        ...
        }else if (this.mode.getValue() == AutoLmod.Français){
            if (Keyboard.isKeyDown(KEY_P)) {
                Random r = new Random();
                mc.thePlayer.sendChatMessage(LMessagesFrançais[r.nextInt(LMessagesFrançais.length)]);
            }
