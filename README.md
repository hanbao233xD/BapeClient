...
本版本由 Leo-Hong (leohca (at) http://yahoo.com) 翻译整理, Chao-Hong Liu 校正.
...
本通用公共授权并不允许您将本程序并入专有程序中。若您的程序是一子程序函数库时，您可能认为允许专有应用程序与该函式库相连结会更有帮助。若这是您所想做的，请使用GNU函式库通用公共授权代替本授权。GNU General Public License (GPL)本通用公共授权并不允许您将本程序并入专有程序中。若您的程序是一子程序函数库时，您可能认为允许专有应用程序与该函式库相连结会更有帮助。若这是您所想做的，请使用GNU函式库通用公共授权代替本授权。
